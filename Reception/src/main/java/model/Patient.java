...
public class Patient implements Serializable, Updatable {
    @Serial
    ...
    public String toString() {
        return id + " " + name + " " + surname + " " + patronymic + " " +gender + " " +dateOfBirth + " " +status + "\n";
    }
    ...
    @Override
    public void update(Updatable newItem) {
        Patient patient = (Patient) newItem;
